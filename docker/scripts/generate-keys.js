...
if (JWT_SECRET.length < 32) {
  console.error('⚠️  Warning: JWT_SECRET should be at least 32 characters long for security');
  console.error('');
}
...
console.log('');
console.log('⚠️  Keep SERVICE_ROLE_KEY secret - it bypasses all security rules!');
