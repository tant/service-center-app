...
This section has been moved to a dedicated document to provide a more focused and detailed guide for developers.

For all standards related to page structure, layout, tables, cards, modals, drawers, spacing, and typography, please refer to the official **UI Coding Guide**.

**➡️ [Read the UI Coding Guide](./UI_CODING_GUIDE.md)**

This guide is the single source of truth for implementing consistent and high-quality user interfaces across the application.
---
---
