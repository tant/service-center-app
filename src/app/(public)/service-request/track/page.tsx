          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  onClick={handleTrack}
                  disabled={!token || token.length < 5 || isLoading}
                >
              ...
              <div className="space-y-6 pt-4">
                ...
                {!trackingData.found ? (
                  <Alert variant="destructive">
                    ...
                    <AlertDescription>
                      <strong>Không tìm thấy yêu cầu.</strong> Vui lòng kiểm tra
                      lại mã theo dõi.
                      <ul className="list-disc list-inside mt-2 text-sm">
                        <li>
                          Đảm bảo mã theo dõi chính xác (định dạng:
                          SR-XXXXXXXXXXXX)
                        </li>
                  ...
                  "request" in trackingData && (
                    <>
                      ...
                      <RequestStatusTimeline
                        timeline={trackingData.request.timeline}
                      />
                                ...
                                <div className="space-y-1">
                                  ...
                                  {item.linked_ticket && (
                                    <div className="mt-2 px-2 py-1 bg-muted rounded text-xs">
                                      ...
                                      <p className="font-medium">
                                        {item.linked_ticket.ticket_number}
                                      </p>
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-2 text-sm">
                            <div>
                              ...
                              <p className="font-medium">
                                {formatDistanceToNow(
                                  new Date(trackingData.request.submitted_at),
                                  {
                                    addSuffix: true,
                                    locale: vi,
                                  },
                      ...
                      <Card>
                        ...
                        <CardContent className="text-sm">
                          <p className="text-muted-foreground">
                            {trackingData.request.issue_description}
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent className="grid md:grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <p className="font-medium">
                              {trackingData.request.customer_name}
                            </p>
                          </div>
                          <div>
                            <p className="text-muted-foreground">Email</p>
                            <p className="font-medium font-mono text-xs">
                              {trackingData.request.customer_email}
                            </p>
                          </div>
                          <div>
                            <p className="text-muted-foreground">
                            ...
                            <p className="font-medium font-mono">
                              {trackingData.request.customer_phone}
                            </p>
                          </div>
                        </CardContent>
                      </Card>
                      ...
                      {/* AC 7: Linked Tickets */}
                      {trackingData.request.items.some(
                        (item) => item.linked_ticket,
                      ) && (
                        <Alert>
                          <AlertDescription>
                            {trackingData.request.items.filter(
                              (item) => item.linked_ticket,
                            ).length === 1
