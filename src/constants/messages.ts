...
export const CONFIRMATION_MESSAGES = {
  ...
  delete_task_type:
    "Are you sure you want to delete this task type? This will affect all templates using it.",
  complete_task: "Mark this task as completed?",
  block_task:
    "Are you sure you want to block this task? You will need to provide a reason.",
  skip_task:
    "Are you sure you want to skip this task? This action cannot be undone.",
  change_template:
    "Changing the template will modify existing tasks. Continue?",

  // Warehouse management
  delete_warehouse:
    "Are you sure you want to delete this warehouse? All products must be moved first.",
  dispose_product:
    "Are you sure you want to dispose of this product? This action cannot be undone.",
  ...
  // Service requests
  reject_request:
    "Are you sure you want to reject this service request? The customer will be notified.",
  approve_request: "Approve this service request and create a service ticket?",
  convert_request:
    "Convert this request to a service ticket? This will create a new customer if needed.",
  cancel_request: "Cancel this service request?",

  // RMA
  delete_rma_batch: "Are you sure you want to delete this RMA batch?",
  ship_rma_batch:
    "Mark this RMA batch as shipped? This action cannot be undone.",
...
export const INFO_MESSAGES = {
  ...
  strict_sequence_enabled:
    "Strict sequence is enabled. Tasks must be completed in order.",
  ...
  template_preview:
    "Preview how this template will appear for service tickets.",

  // Warehouse management
  serial_verification_help: "Scan or enter serial number to verify product.",
  bulk_import_help:
    "Upload CSV file with columns: serial_number, product_sku, condition, warehouse_type.",
  low_stock_alert: "Stock level is below minimum threshold.",
  warranty_expiring_soon: "Warranty expires in {{days}} days.",
  product_in_service:
    "This product is currently assigned to service ticket {{ticket_number}}.",

  // Service requests
  tracking_lookup_help:
    "Enter your tracking token (SR-XXXXXXXXXXXX) to check request status.",
  public_portal_maintenance:
    "The service request portal is currently under maintenance. Please try again later.",
  review_pending:
    "This request is pending review. We will notify you once it has been reviewed.",
  request_converted_info:
    "This request has been converted to service ticket {{ticket_number}}.",
