...
export const MOVEMENT_TYPE_OPTIONS: {
...
}[] = [
  {
    value: "receipt",
    label: "Receipt",
    description: "Product received from supplier",
  },
  {
    value: "transfer",
    label: "Transfer",
    description: "Move between warehouse locations",
  },
  {
    value: "assignment",
    label: "Assignment",
    description: "Assign to service ticket",
  },
  {
    value: "return",
    label: "Return",
    description: "Return from service ticket",
  },
  {
    value: "disposal",
    label: "Disposal",
    description: "Product disposed or scrapped",
  },
];
