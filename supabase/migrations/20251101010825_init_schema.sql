...
alter table "public"."service_ticket_tasks" add constraint "service_ticket_tasks_task_id_fkey" FOREIGN KEY (task_id) REFERENCES public.tasks(id) ON DELETE RESTRICT not valid;

alter table "public"."service_ticket_tasks" validate constraint "service_ticket_tasks_task_id_fkey";
...
alter table "public"."service_ticket_tasks" add constraint "service_ticket_tasks_workflow_task_id_fkey" FOREIGN KEY (workflow_task_id) REFERENCES public.workflow_tasks(id) ON DELETE SET NULL not valid;

alter table "public"."service_ticket_tasks" validate constraint "service_ticket_tasks_workflow_task_id_fkey";
...
alter table "public"."workflows" add constraint "workflows_product_type_fkey" FOREIGN KEY (product_type) REFERENCES public.products(id) ON DELETE CASCADE not valid;

alter table "public"."workflows" validate constraint "workflows_product_type_fkey";
