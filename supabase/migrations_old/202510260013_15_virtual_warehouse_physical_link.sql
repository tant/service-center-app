...
SET name = display_name, physical_warehouse_id = NULL
...
COMMENT ON FUNCTION public.create_default_virtual_warehouse() IS 'Auto-create default virtual warehouse when physical warehouse is created';
...
BEGIN
  ...
  IF OLD.name IS DISTINCT FROM NEW.name THEN
    ...
    SET 
      ...
      display_name = NEW.name || ' - Kho Chính',
