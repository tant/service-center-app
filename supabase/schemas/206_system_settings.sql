-- =====================================================
-- 206_system_settings.sql
-- =====================================================
-- Centralized application settings (key/value JSONB)
-- Dependencies: 150_base_functions (is_admin_or_manager, update_updated_at_column)
-- =====================================================
...
-- Keep JSONB searchable if needed
...
-- Seed default record placeholder for default workflows
